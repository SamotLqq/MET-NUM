...
function y = f(x)
    y = x.*x; 
    // si x es vector multiplica componente a componente el contenido de los vectores, ie, si x = [1 2 3] -> [1 4 9] es el retorno. es la funcion x^2
endfunction
...
ih = (0:16)'; // step implícito 1. ' traspone el vector
h = (10.^-ih); // Vector con los valores de h 10^0 10^-1 10^-2 ... 10^-16
